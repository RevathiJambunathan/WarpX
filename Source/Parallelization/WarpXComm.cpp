...
WarpX::UpdateAuxilaryDataSameType ()
{
    ...
    for (int lev = 0; lev <= 0; ++lev)
    {
        ...
        ablastr::coarsen::average::Coarsen( *crse_B[0], *fine_B[0], refinement_ratio );
        ablastr::coarsen::average::Coarsen( *crse_B[1], *fine_B[1], refinement_ratio );
        ablastr::coarsen::average::Coarsen( *crse_B[2], *fine_B[2], refinement_ratio );
        ...
        ablastr::coarsen::average::Coarsen( *crse_E[0], *fine_E[0], refinement_ratio );
        ablastr::coarsen::average::Coarsen( *crse_E[1], *fine_E[1], refinement_ratio );
        ablastr::coarsen::average::Coarsen( *crse_E[2], *fine_E[2], refinement_ratio );
